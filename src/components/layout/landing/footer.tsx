...
export default function Footer() {
  return (
    <footer className="py-16 md:py-20 border-dashed border-t bg-muted dark:bg-background">
      <div className="mx-auto max-w-6xl px-6 flex flex-col gap-10">
        ...
        <Separator className="mx-auto max-w-64 md:max-w-xl opacity-30" />
        ...
        <div className="flex flex-col gap-6">
          <div className="flex flex-wrap justify-center gap-6 text-sm">
            ...
            <a
              href="https://www.linkedin.com/company/sophistaiapp"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="LinkedIn"
              className="text-muted-foreground hover:text-primary block"
            ...
            <a
              href="https://www.facebook.com/share/166PrqoRX5/"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Facebook"
              className="text-muted-foreground hover:text-primary block"
            ...
            <a
              href="https://www.instagram.com/sophist_ai"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://www.youtube.com/@sophistai_app"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="YouTube"
              className="text-muted-foreground hover:text-primary block"
